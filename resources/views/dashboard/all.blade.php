...
@section('content')
    <h1 class="text-center">{{ $name }} panel</h1>
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="d-flex">
                                {{-- button rekap --}}
                                <form action="/dashboard/{{ $name }}" method="GET" class="pr-3 pl-3">
                                ...
                                <a href="/{{ $name }}/export/{{ $no_rekap }}" class="btn btn-success ml-3">
                                    Export
                                    excel</a>
                        ...
                        <div class="col-4">
                            <div class="cari">
                                <form action="/dashboard/{{ $name }}" action="GET"
                    ...
                    <div class="table-responsive mt-5">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tfoot>
                                ...
                                <td class="text-center"><strong>Total Penerimaan: Rp. {{ $totalPenerimaan }} </strong>
                                </td>
                                <td class="text-center"><strong>Total Pengeluaran: Rp. {{ $totalPengeluaran }} </strong>
                                </td>
