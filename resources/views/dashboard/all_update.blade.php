...
@section('content')
    <h1 class="text-center name">{{ $name }} pembayaran panel</h1>
                                ...
                                <form method="post" action="/dashboard/semester/{{ $data->id }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local"
                                            ...
                                            id="tanggal_bayar" name="update_tanggal" value="{{ $data->tanggal }}">
                                        @error('tanggal_bayar')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                            id="kode" name="update_kode" value="{{ $data->kode }}">
                                        @error('kode')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('uraian') is-invalid @enderror"
                                            id="uraian" name="update_uraian" value="{{ $data->uraian }}">
                                        @error('uraian')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('penerimaan') is-invalid @enderror"
                                            id="penerimaan" name="update_penerimaan" value="{{ $data->penerimaan }}">
                                        @error('penerimaan')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="pengeluaran" name="update_pengeluaran" value="{{ $data->pengeluaran }}">
                                        @error('pengeluaran')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('saldo') is-invalid @enderror"
                                            id="saldo" name="update_saldo" value="{{ $data->saldo }}">
                                        @error('saldo')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
